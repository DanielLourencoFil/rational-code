...
works now.* Untreated, each of those is a burden-shift — the agent asserts for free,
and the human either investigates (expensive) or accepts (dangerous). Multiply by
